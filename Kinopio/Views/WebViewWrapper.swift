...
struct WebViewWrapper: UIViewRepresentable {
    ...
    func makeCoordinator() -> Coordinator {
        return Coordinator(url: $url, isLoading: $isLoading, backgroundColor: $backgroundColor, isManageSubscriptionsSheetVisible: $isManageSubscriptionsSheetVisible)
    }
    ...
    class Coordinator: NSObject {
        ...
        init(url: Binding<URL>, isLoading: Binding<Bool>, backgroundColor: Binding<Color>, isManageSubscriptionsSheetVisible: Binding<Bool>) {
            _url = url
            _isLoading = isLoading
            _backgroundColor = backgroundColor
            _isManageSubscriptionsSheetVisible = isManageSubscriptionsSheetVisible
...
extension WebViewWrapper.Coordinator: WKScriptMessageHandler {
    func userContentController(_ userContentController: WKUserContentController, didReceive message: WKScriptMessage) {
        ...
        else if message.name == "showManageSubscriptions" {
            isManageSubscriptionsSheetVisible = true
        }
        else {
